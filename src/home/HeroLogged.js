            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center max-w-screen-xl mx-auto px-8">
                <div className="lg:col-span-7">
                    ...
                    <div className="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                        ...
                        <Link
                            to="/dashboard"
                            className="inline-flex items-center justify-center w-full px-5 py-3 text-sm font-medium text-center text-black bg-gray-200 rounded-lg sm:w-auto hover:bg-gray-300 focus:ring-4 focus:ring-indigo-30"
                        >
                            Dashboard
                        </Link>
                    </div>
